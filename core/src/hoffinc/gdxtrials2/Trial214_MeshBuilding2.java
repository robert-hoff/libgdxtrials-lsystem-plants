 ...
 *
 */
public class Trial214_MeshBuilding2 extends ApplicationAdapter {
  ...
  private Vector3 calculateNormal(int circle_ind, int vertex_id) {
    ...
    // System.err.println(normal_0);
    // System.err.println(normal_1);
    // System.err.println(normal_2);
    // System.err.println(normal_3);
  ...
  Model buildTrunkModelExperiment(int rgb) {
    ModelBuilder modelBuilder = new ModelBuilder();
    modelBuilder.begin();
    ...
    Vector3 v5 = trunkCircles.get(1)[0];
    Vector3 v6 = trunkCircles.get(1)[1];
    Vector3 v7 = trunkCircles.get(1)[2];
    Vector3 v8 = trunkCircles.get(1)[3];
    Vector3 v9 = trunkCircles.get(1)[4];

    Vector3 t1 = new Vector3(v6).sub(v0);
    Vector3 t2 = new Vector3(v5).sub(v0);
    Vector3 n0 = new Vector3(t1).crs(t2).nor();

    t1 = new Vector3(v5).sub(v4);
    t2 = new Vector3(v9).sub(v4);
    Vector3 n1 = new Vector3(t1).crs(t2).nor();
    ...
    meshBuilder.vertex(v9, n0, null, null);
    meshBuilder.triangle((short) 0, (short) 6, (short) 5); // CCW winding
  ...
  private int CIRCLE_VERTEX_COUNT = 5;
