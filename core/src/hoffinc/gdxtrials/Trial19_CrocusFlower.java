...
public class Trial19_CrocusFlower extends ApplicationAdapter {
  ...
  public void create () {
    ...
    MyGameState.miniPopup.addListener("Inc iterations", new ActionListener() {
      @Override
      public void actionPerformed(ActionEvent e) {
        if (iterations < 19) {
          iterations++;
    ...
    MyGameState.miniPopup.addListener("Dec iterations", new ActionListener() {
      @Override
      public void actionPerformed(ActionEvent e) {
        if (iterations > 1) {
          iterations--;
